<?php
echo	"NAMA 			: SCRIPT SPAM DOS FOR WhatsApp
		 DIGUNAKAN 		: BISA BERKALI-KALI
...
echo "gunakan script ini dengan bijak dan teliti\n\n";
echo "pembuat script :RIZKY RAMBU ANARKI\n\n";
echo "SUBSCRIBE CHANNEL YOUTUBE :Rizky Creator Custom\n\n";
...
echo "masukan nomor target diawali 62/08\nMASUKAN NOMOR DISINI : ";
...
echo "SPAM INI AKAN SEGERA DIKIRIM: $nomer (konfirmasi/batal)";
$cek = trim(fgets(STDIN));
if($cek=="n") exit("Stopped!\n");
echo "PAKET YANG AKAN DIKIRIMKAN\nJUMLAH : ";
